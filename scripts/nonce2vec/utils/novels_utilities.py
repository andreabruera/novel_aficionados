...
def cleanup_novels(char_list, lines, out, write_to_file, wiki_novel=False):
    current_char_list = []
    full_novel = []
...
def prepare_for_n2v(folder, number, filename, w2v_model=None, write_to_file=False, wiki_novel=False):
    ...
    if wiki_novel==False:
        ...
        current_char_list, full_novel = cleanup_novels(char_list, lines, out, write_to_file, wiki_novel=True)
...
def prepare_for_bert(folder, number, filename, write_to_file=False, wiki_novel=False):
