...
for novel in os.listdir(big):
    ...
    setup_folder=os.listdir('{}/{}'.format(big, novel))
    #median=[]
    #characters=0
    ...
    if 'bert' not in args.training_mode or 'layer_12' in base_folder: 
        ...
        if marker==True:
            ...
            original_file=os.listdir('{}/{}/original_novel'.format(big, base_novel))
            open_file=open('{}/{}/original_novel/{}'.format(big, base_novel, original_file[0])).read()
...
if average_characters>1.0:
    ...
    if args.make_plots:
        results_output=open('{}/wiki_doppel_results_{}.txt'.format(output_folder, novel),'w')
...
if args.make_plots:
    ...
    with open('{}/wiki_doppel_ambiguities_info.txt'.format(output_folder), 'w') as ambiguity_file:
    ...
    novels_info=open('{}/wiki_{}_novels_info.txt'.format(output_folder, setup_shorthand), 'w')
    ...
    plt.tight_layout()
    plt.savefig('{}/wiki_doppel_median_lenghts.png'.format(output_folder), dpi=1200, format='png', bbox_inches='tight', pad_inches=0.2)
    ...
    plt.legend(loc='best', ncol=2, borderaxespad=0.)
    plt.tight_layout()
    plt.savefig('{}/wiki_doppel_median_characters.png'.format(output_folder), dpi=1200, format='png', bbox_inches='tight', pad_inches=0.2)
    ...
    plt.legend(loc='best', ncol=2, borderaxespad=0.)
    plt.tight_layout()
    plt.savefig('{}/wiki_doppel_median_frequency_std.png'.format(output_folder), dpi=1200, format='png', pad_inches=0.2, bbox_inches='tight')
    ...
    plt.legend(loc='best', ncol=2, borderaxespad=0.)
    plt.tight_layout()
    plt.savefig('{}/wiki_doppel_median_names.png'.format(output_folder, setup, novel), dpi=1200, format='png', bbox_inches='tight', pad_inches=0.2)
    plt.clf()
    ...
    plt.legend(loc='best', ncol=2, borderaxespad=0.)
    plt.tight_layout()
    plt.savefig('{}/wiki_doppel_mrr_lengths.png'.format(output_folder), dpi=1200, format='png', bbox_inches='tight', pad_inches=0.2)
    ...
    plt.legend(loc='best', ncol=2, borderaxespad=0.)
    plt.tight_layout()
    plt.savefig('{}/wiki_doppel_MRR_characters.png'.format(output_folder), dpi=1200, format='png', bbox_inches='tight', pad_inches=0.2)
    ...
    plt.legend(loc='best', ncol=2, borderaxespad=0.)
    plt.tight_layout()
    plt.savefig('{}/wiki_doppel_MRR_characters_std.png'.format(output_folder), dpi=1200, format='png', bbox_inches='tight', pad_inches=0.2)
    ...
    plt.legend(loc='best', ncol=2, borderaxespad=0.)
    plt.tight_layout()
    plt.savefig('{}/wiki_doppel_MRR_names.png'.format(output_folder), dpi=1200, format='png', bbox_inches='tight', pad_inches=0.2)
    plt.clf()
