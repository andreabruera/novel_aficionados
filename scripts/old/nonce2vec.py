...
class Nonce2VecVocab(Word2VecVocab):
    ...
    def prepare_vocab(self,novel_count, hs, negative, wv, update=False,
...
class Nonce2Vec(Word2Vec):
    ...
    def build_vocab(self, novel_count, sentences, update=False, progress_per=10000,
        ...
        report_values, pre_exist_words = self.vocabulary.prepare_vocab(
            novel_count, self.hs, self.negative, self.wv, update=update,
